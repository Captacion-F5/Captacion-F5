        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                <tr class="hover:bg-orange-200">
                    ...
                    <td class="py-4">
                        <a href="#"  class="p-2 rounded-full font-medium text-green bg-green-200 hover:underline">Completado</a>
                    </td>
                    <td class="">
                        <div class="flex">
                ...
                <tr class="hover:bg-orange-200">
                    ...
                    <td class=" py-4">
                        <a href="#" class="p-2 rounded-full font-medium text-blue bg-blue-200 hover:underline">Pendiente</a>
