    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <div class="search filter d-flex">
            {{-- <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead class="px-1 py-2 text-xs text-white uppercase bg-naranja dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                ...
                <tbody class="text-center">
                    <tr class="hover:bg-orange-200">
                        ...
                        <td class="">
                            <a href="#"
                                class=" rounded-full font-medium text-green bg-green-200 hover:underline">Completado</a>
                        </td>
                        <td class="">
                            <div class="flex">
                                <div class=" transform hover:text-naranja hover:scale-150">
                                ...
                                <div class=" transform hover:text-red-800 hover:scale-150">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <tr class="hover:bg-orange-200">
                        ...
                        <td class="">
                            <a href="#"
                                class="rounded-full font-medium text-green bg-blue-200 hover:underline">Pendiente</a>
                        </td>
                        <td class="">
                            <div class="flex">
                                <div class=" transform hover:text-naranja hover:scale-150">
                    ...
                    <tr class="hover:bg-orange-200">
                        ...
                        <td class="">
                            <a href="#"
                                class=" rounded-full font-medium text-blue bg-blue-200 hover:underline">Pendiente</a>
                        </td>
                        <td class="">
                            <div class="flex">
                                <div class=" transform hover:text-naranja hover:scale-150">
