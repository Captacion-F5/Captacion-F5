...
<table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
    ...
    <tbody>
        <tr class="hover:bg-orange-200">
            ...
            <td class="">
                <a href="#"
                    class="p-2 rounded-full font-medium text-red bg-red-200 hover:underline">Finalizado</a>
            </td>
            <td>Icono</td>
            <td>Icono</td>
            <td class="">
        ...
        <tr class="hover:bg-orange-200">
            ...
            <td class="">
                <a href="#" class="p-2 rounded-full font-medium text-green bg-green-200 hover:underline">En
                    curso</a>

            </td>
            <td class="text-naranja">
                Icono
            </td>
            <td class="text-naranja">
                Icono
